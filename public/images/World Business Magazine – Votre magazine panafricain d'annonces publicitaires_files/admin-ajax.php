...
@font-face {
    font-family: "Aileron";
    src: url("https://worldbusinessmag.com/wp-content/themes/cesis/includes/fonts/aileron/Aileron-Italic.otf");
 }
@font-face {
    font-family: "Aileron";
    src: url("https://worldbusinessmag.com/wp-content/themes/cesis/includes/fonts/aileron/Aileron-BoldItalic.otf");
    font-weight: bold;
}
@font-face {
    font-family: "Aileron";
    src: url("https://worldbusinessmag.com/wp-content/themes/cesis/includes/fonts/aileron/Aileron-LightItalic.otf");
    font-weight: 300;
}
@font-face {
    font-family: "Aileron";
    src: url("https://worldbusinessmag.com/wp-content/themes/cesis/includes/fonts/aileron/Aileron-Regular.otf");
}
@font-face {
    font-family: "Aileron";
    src: url("https://worldbusinessmag.com/wp-content/themes/cesis/includes/fonts/aileron/Aileron-Bold.otf");
    font-weight: bold;
}
@font-face {
    font-family: "Aileron";
    src: url("https://worldbusinessmag.com/wp-content/themes/cesis/includes/fonts/aileron/Aileron-SemiBold.otf");
    font-weight: 600;
}
@font-face {
    font-family: "Aileron";
    src: url("https://worldbusinessmag.com/wp-content/themes/cesis/includes/fonts/aileron/Aileron-Light.otf");
    font-weight: 300;
}
...
p{margin:0 0 17px 0;}
h1{ font-family:Open Sans; font-size:40px; line-height:48px; letter-spacing:0px;  font-weight:300; margin-bottom:28px;}
h2{ font-family:Open Sans; font-size:34px; line-height:40px; letter-spacing:0px;  font-weight:300; margin-bottom:31px;}
h3{ font-family:Open Sans; font-size:28px; line-height:36px; letter-spacing:0px;  font-weight:; margin-bottom:18px;}
h4{ font-family:Open Sans; font-size:24px; line-height:32px; letter-spacing:0px;  font-weight:; margin-bottom:18px;}
h5{ font-family:Open Sans; font-size:18px; line-height:27px; letter-spacing:0px;  font-weight:700; margin-bottom:19px;}
h6{ font-family:Open Sans; font-size:16px; line-height:24px; letter-spacing:0px;  font-weight:700; margin-bottom:20px;}
blockquote{ font-family:Open Sans; font-size:22px; line-height:32px; letter-spacing:0px;  font-weight:300;}

.agency_container .author-info h3,.agency_comments_ctn .author,.comments-layout-seven .author{ font-family:Open Sans;  font-weight:300;}
...
.header_top_bar { background:#000000; border-color:#000000; color:#fff99f}
.header_top_bar a{ color:#6d7783;}
.header_top_bar a:hover{ color:#f5e93d;}
...
.header_main { background:#f5e93d; height:90px; border-color:rgba(235,235,235,0.5);}
#header_container.cesis_opaque_header{ background:#f5e93d;}
...
.header_logo{  max-width:266px;}.header_logo #logo_img,.header_logo #logo_img img{  max-width:266px;  max-height:90px; }
.header_logo.logo_center{ width:266px; margin-left:-133px; }
.sm .cl_before_logo{ margin-right:133px; }.sm .cl_after_logo{ margin-left:163px; }
body.rtl .sm .cl_before_logo{ margin-left:133px; margin-right:0; }body.rtl .sm .cl_after_logo{ margin-right:163px; margin-left:0; }

.tt-main-navigation  > div > ul > li > a span,.tt-main-navigation.tt-vertical-navigation span,
.tt-main-additional .cesis_search_icon span,.tt-main-additional .cesis_search_icon input,
.tt-main-additional .cesis_cart_icon.vertical, .tt-main-additional .cesis_cart_icon.vertical a,
.tt-main-additional .cesis_bp_notifications.vertical a
{ color:#000000; font-family:Open Sans; font-size:13px; font-weight:600; text-transform:uppercase; letter-spacing:0px;}
...
.tt-main-additional .cesis_bp_notifications a { color:#f5e93d;}
...
{background-color:rgba(245,233,61,1); border-color:rgba(255,255,255,0)}
...
.tt-main-navigation:not(.tt-vertical-navigation) .sub-menu li > a > span:hover{color:#000000; Background:#f5e93d;}
...
/* title */
.main-title{ color:#293340; font-family:Open Sans; font-size:28px; text-transform:none; letter-spacing:0px;  font-weight:; }
...
::selection{ background:#f5e93d; color:white; }
...
{color:#ffffff; background:rgba(245,233,61,1); border-color:rgba(245,233,61,1);  font-family:Open Sans; font-size:15px; font-weight:; text-transform:none; letter-spacing:0px;  }
...
{color:#293340; background:rgba(244,244,244,1); border-color:rgba(236,236,236,1);  font-family:Open Sans; font-size:15px; font-weight:; text-transform:none; letter-spacing:0px;}
...
.cesis_alt_btn[class*="tg-"]{color:#293340 !important; background:rgba(244,244,244,1) !important; border-color:rgba(236,236,236,1) !important;  font-family:Open Sans !important; font-size:15px !important; font-weight: !important; text-transform:none !important; letter-spacing:0px !important;}
...
{color:#14171d; background:rgba(255,255,255,1); border-color:rgba(255,255,255,1);  font-family:Open Sans; font-size:13px; font-weight:; text-transform:uppercase; letter-spacing:1px;}
...
.cesis_f_widget_title { font-family:Open Sans; font-size:16px; letter-spacing:1px; text-transform:uppercase; margin-bottom:40px; }
...
.footer_main a:hover,.footer_main h1 a:hover,.footer_main h2 a:hover,.footer_main h3 a:hover,.footer_main h4 a:hover,.footer_main h5 a:hover,.footer_main h6 a:hover{ color:#f5e93d; }

.footer_widget .tagcloud a:hover{ background:#f5e93d; }

.footer_widget .tagcloud a:hover{ border-color:#f5e93d; }
...
.footer_sub a:hover{ color:#f5e93d; }
...
aside.main-sidebar section > h2,.wpb_widgetised_column section > h2{ font-family:Open Sans; font-size:16px; letter-spacing:0px; text-transform:none; margin-bottom:32px; line-height:24px; }
...
.sidebar_layout_one section a:hover,.sidebar_layout_two section a:hover,.sidebar_layout_three section a:hover{ color:#f5e93d; }
...
.sidebar_layout_two .tagcloud a:hover { background:#f5e93d; border-color:#f5e93d; color:#ffffff; }

/* layout three */


.sidebar_layout_three .tagcloud a{border:1px solid #edf0f7; font-family:Open Sans;  color:#6d7783; background:#ffffff;}
.sidebar_layout_three .tagcloud a:hover { background:#f5e93d; border-color:#f5e93d; color:#ffffff; }

.sidebar_layout_three .cesis_widget_title:after { background:#f5e93d; }
...
--------------------------------------------------------------*/
 ...
 #cesis_to_top {
    color: #000 !important;
    background-color: rgba(245,233,61,0.4) !important;
}

#cesis_to_top:hover {
    color: #000 !important;
    background-color: rgba(245,233,61,1) !important;
}

.menu-footer-menu-bottom-container li a {
    color: #aeb7c1 !important;
}


.menu-footer-menu-bottom-container li a:hover {
    color: #f5e93d !important;
}
