...
import { Box, Container, Grid, Pagination, Divider, Button, Typography } from "@mui/material";
...
const Article = () => {
  ...
  return (
    <>
      ...
      <Container>
        <div className="">{/* <ArticleListToolbar /> */}</div>
                ...
                <div className="flex flex-nowrap mt-2">
                  ...
                  <div className="basis-9/12 ">
                    <div className="ml-5" style={{ width: "700px" }}>
                      <p className="text-sm pb-2 text-gray-500">Source: {item.redacteur}</p>
                      <h2 className="text-lg font-bold font-serif text-gray-900">{item.title}</h2>

                      <p className="text-sm font-sans text-white text-gray-700">
                        {item.description}
                      </p>
                      <p className="text-sm pt-2 text-gray-500">{item.nbVues} Lectures</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="flex justify-center">
          ...
          >
            <PaginatedItems pageCount={pageCount} handlePageClick={handlePageClick} />
          </Box>
        </div>
      </Container>
    </>
